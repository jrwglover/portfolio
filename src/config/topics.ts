        ...
        leaves: [
          {
            ...
            slug: 'market-pv01',
            title: 'Market PV01',
            subtitle: 'Instrument-level bump-and-rebuild risk ladders',
            description:
              'Market-quote PV01 from the engine: every input instrument bumped 1bp, the curve family re-bootstrapped, a seasoned broken-dated swap repriced. Dual-curve decomposition (EURIBOR projection vs ESTR discounting), CPU re-bootstrap vs GPU pillar ladders, and the FX/xccy curve risked per spot, swap-point and basis pillar.',
            techBadges: ['C++', 'CUDA', 'QuantLib', 'GlobalBootstrap'],
            highlights: ['Projection vs discounting split', 'CPU vs GPU ladders', 'FX/xccy per-pillar risk'],
            status: 'live',
