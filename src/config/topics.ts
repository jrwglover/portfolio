        ...
        leaves: [
          {
            id: 'curve-domains',
            slug: 'curve-domains',
            title: 'Forward / Zero / Par',
            subtitle: 'One curve read three ways, the way a desk reads it',
            description:
              'The same bootstrapped curve in all three domains at once: the par swap rate a desk quotes and hedges, the zero rate that discounts cashflows, and the instantaneous forward the curve implies about future overnight rates. Par is rebuilt from the displayed zero curve on the correct fixed-leg accrual basis and recovers the input market quotes to 0.0bp on ESTR, SOFR and SONIA. Switch curves to see how the meeting-dated and IMM builds show policy steps in the forward domain that par averages away.',
            techBadges: ['C++', 'QuantLib', 'GlobalBootstrap'],
            highlights: ['Three domains side by side', 'Par recovers quotes to 0.0bp', 'Step structure visible only in forwards'],
            status: 'live',
            dashboard: { component: 'CurveModelDashboard', defaultTab: 'domains' },
            breadcrumb: ['Rates', 'Curve Views', 'Forward / Zero / Par'],
          },
        ],
      },
      {
